...
public class Registro extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        cmbReporte.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "::: Selec. Reporte :::", "Pie", "Barras", "barraspunto" }));
    ...
    private void abrirReporte(String tipoReporte) {
        ...
        if (tipoReporte.equalsIgnoreCase("barraspunto")) {
            crearReporte("mireporte");return;
        }
    }
